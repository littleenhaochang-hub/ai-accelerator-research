...
# --- 2D Hadamard A4KV4 Attention ---
def a4kv4_2d_forward(self, hidden_states, attention_mask=None, position_ids=None, past_key_value=None, past_key_values=None, output_attentions=False, use_cache=False, cache_position=None, position_embeddings=None, **kwargs):
    hidden_states = fake_quantize(hidden_states, bits=4) # A4 input to Attention
...
# --- FFN A8W4 (Block 32 for Weights, 8-bit for Activations) ---
...
def run():
    ...
    print("\nRunning Config: A4KV4 (2D Hadamard) + FFN A8W4 (Block 32)")
    ...
    Qwen2Attention.forward = a4kv4_2d_forward
