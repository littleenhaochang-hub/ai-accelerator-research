...
target_layer = 12
num_experts = 60
k = 4 # Qwen routes to 4 experts

# Extract features (X) from Layer 2 and targets (Y) from Layer 12
...
print(f"\nTraining Linear Lookahead Predictor...")
...
print(f"Model: Linear Probe (Single Layer)")
print(f"Lookahead Window: {target_layer - early_layer} layers (Massive SSD Prefetch Window)")
print(f"Predictor Cache Hit Rate: {hit_rate*100:.2f}% (vs 6.6% random chance)")
